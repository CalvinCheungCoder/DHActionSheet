...
@interface DHActionSheetView ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation DHActionSheetView

//
- (instancetype)initWithTitle:(NSString *)title delegate:(id<DHActionSheetViewDelegate>)actionSheetViewDelegate cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...{
    self = [super init];
    if (self) {
        ...
        //
        [self dh_setupdhActionSheetViewSubviews];
    }
    return self;
}

#pragma mark - block
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtons actionSheetBlock:(DHActionSheetViewBlock)actionSheetBlock{
    self = [super init];
    if (self) {
...
- (void)dh_setupdhActionSheetViewSubviews{
...
- (void)dh_show{
    [self dh_showInView:[UIApplication sharedApplication].delegate.window];
}
//
- (void)dh_showInView:(UIView *)view{
    if (nil == view) {
...
//
- (void)dh_didTapBackground:(id)sender{
...
//取消
- (void)dh_cancelButtonClicked:(id)sender{
...
- (UIButton *)backgroudView{
    if (_backgroudView == nil) {
        ...
        [_backgroudView addTarget:self action:@selector(dh_didTapBackground:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView setBackgroundColor:RGBColor(239.0, 239.0, 244.0, 1.0)];
...
- (UIButton *)cancelButton{
    if (_cancelButton == nil) {
        ...
        [_cancelButton addTarget:self action:@selector(dh_cancelButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        [_cancelButton setBackgroundImage:[UIImage dh_imageWithColor:[UIColor colorWithWhite:0.5 alpha:0.3]] forState:UIControlStateHighlighted];
    }
